...
<script>
    ...
    export default {
        ...
        methods: {
            fetchData() {
                let _self = this;
                this.axios.get(this.url+"course/getAllCourse.do").then(function (response) {
            ...
            deleteMessage(){
                let _self = this;
                this.axios.get(this.url + "course/deleteCourse.do",{params:{courseId:this.deleteId}}).then(function (response) {
