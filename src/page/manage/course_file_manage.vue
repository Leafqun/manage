        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-headline">
                ...
                <div class="panel-body">
                    <form role="form" id="form3" action="javascript:void(0)">
                        <table class="table">
                            <thead>
                            <tr>
                            ...
                            <tr v-for="(courseFile,index) in courseFileList"
                                ...
                                <td><input type="checkbox" name="cfileId" :value="courseFile.cfileId"></td>
...
<script>
    export default {
        ...
        methods: {
            ...
            deleteTable() {
                let _self = this;
                this.axios.get(this.url + "course/deleteCourseFile.do", {params: {cfileId: this.deleteId}}).then(response => {
            ...
            batchDelete() {
                ...
                let _self = this;
                this.axios.post(this.url + "course/deleteCourseFileBatch.do", formdata).then(response => {
                    if (response.data.msg == "success") {
                        _self.loading = true;
                        _self.fetchData();
                    }
